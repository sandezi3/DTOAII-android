...
import com.accenture.datongoaii.vendor.HX.LoadLocalBigImgTask;
import com.accenture.datongoaii.vendor.HX.widget.PhotoView;
...
public class ShowBigImage extends Activity {
    ...
    private int default_res = R.drawable.ic_default;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        default_res = getIntent().getIntExtra("default_image", default_res);
        Uri uri = getIntent().getParcelableExtra("uri");
        String remotepath = getIntent().getExtras().getString("remotepath");
        String secret = getIntent().getExtras().getString("secret");
        Logger.d(TAG, "show big image uri:" + uri + " remotepath:" + remotepath);

        //本地存在，直接显示本地的图片
        if (uri != null && new File(uri.getPath()).exists()) {
            Logger.d(TAG, "showbigimage file exists. directly show it");
            ...
            Logger.d(TAG, "download remote image");
    ...
    private void downloadImage(final String remoteFilePath, final Map<String, String> headers) {
        String str1 = Config.PROGRESS_DOWNLOADING_PICTURE;
        ...
        final EMCallBack callback = new EMCallBack() {
            ...
            public void onError(int error, String msg) {
                Logger.e(TAG, "offline file transfer error:" + msg);
            ...
            public void onProgress(final int progress, String status) {
                ...
                final String str2 = Config.PROGRESS_DOWNLOADING_PICTURE;
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
