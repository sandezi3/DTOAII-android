...
import com.accenture.datongoaii.vendor.qrscan.PreferencesActivity;
...
final class CameraConfigurationManager {
    ...
    void setDesiredCameraParameters(Camera camera, boolean safeMode) {
        ...
        // Point cameraPreviewResolution = new Point(cameraResolution);
        // if (cameraPreviewResolution.y * screenResolution.y >
        // cameraPreviewResolution.x * screenResolution.x) {
        // // too wide
        // cameraPreviewResolution.y = cameraPreviewResolution.x *
        // screenResolution.x / screenResolution.y;
        // } else {
        // // too narrow
        // cameraPreviewResolution.x = cameraPreviewResolution.y *
