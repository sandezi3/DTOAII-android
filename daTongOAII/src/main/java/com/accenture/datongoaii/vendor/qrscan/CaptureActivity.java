...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    protected void onResume() {
        ...
        final View descView = findViewById(R.id.textQrScanDesc);
        descView.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
            @Override
            public boolean onPreDraw() {
                ...
                descView.setPadding(0, viewfinderView.getTop() + height / 2 + width * 3 / 9, 0, 0);
                return true;
            }
    ...
    protected void handleDecodeInternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
        ...
        Logger.d(TAG, "handleDecodeInternally: " + format + " => " + content);
        if (!format.equals(BarcodeFormat.QR_CODE) || !content.startsWith(Constants.BARCODE_PREFIX_TAG)) {
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        builder.setTitle(Config.ERROR_CAMERA_INIT_FAIL);
        builder.setMessage(Config.ERROR_CAMERA_INIT_FAIL);
